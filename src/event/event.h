...
namespace FakeEngine
{
    enum EventCategory
    {
        ...
        EveCatMouse         =  (1 << 2 + EVENT_C_SHIFT),
        EveCatKinematics    =  (1 << 3 + EVENT_C_SHIFT),
        EveCatEntComp       =  (1 << 4 + EVENT_C_SHIFT),
        EveCatAssMan        =  (1 << 5 + EVENT_C_SHIFT),
        EveCatCustom        =  (1 << 6 + EVENT_C_SHIFT),
    };
    ...
    enum EventType
    {
        ...
        EveTypeMouseMoved          =  EveCatMouse       + (1 << EVENT_T_SHIFT),
        EveTypeMouseButtonPressed  =  EveCatMouse       + (1 << EVENT_T_SHIFT),
        EveTypeMouseButtonReleased =  EveCatMouse       + (2 << EVENT_T_SHIFT),
        EveTypeMouseScrolled       =  EveCatMouse       + (1 << EVENT_T_SHIFT),
        EveTypeCollision           =  EveCatKinematics  + (1 << EVENT_T_SHIFT),
        EveTypeImpulse             =  EveCatKinematics  + (2 << EVENT_T_SHIFT),
        EveTypeForce               =  EveCatKinematics  + (3 << EVENT_T_SHIFT),
        EveTypeKineticEnergyLoss   =  EveCatKinematics  + (4 << EVENT_T_SHIFT),
        EveTypeGameObjectSpawn     =  EveCatEntComp     + (1 << EVENT_T_SHIFT),
        EveTypeGameObjectDelete    =  EveCatEntComp     + (2 << EVENT_T_SHIFT),
        EveTypeGameObjectSpawned   =  EveCatEntComp     + (3 << EVENT_T_SHIFT),
        EveTypeGameObjectDeleted   =  EveCatEntComp     + (4 << EVENT_T_SHIFT),
        EveTypeAssetLoad           =  EveCatAssMan      + (1 << EVENT_T_SHIFT),
        EveTypeAssetFree           =  EveCatAssMan      + (2 << EVENT_T_SHIFT),
    ...
    static std::map<int, const char*> event_type_strings
    {
        ...
        { EveTypeCollision           ,  "EveTypeCollision"          },
        { EveTypeImpulse             ,  "EveTypeImpulse"            },
        { EveTypeForce               ,  "EveTypeForce"              },
        { EveTypeKineticEnergyLoss   ,  "EveTypeKineticEnergyLoss"  },
        { EveTypeGameObjectSpawn     ,  "EveTypeGameObjectSpawn"    },
        { EveTypeGameObjectDelete    ,  "EveTypeGameObjectDelete"   },
        { EveTypeGameObjectSpawned   ,  "EveTypeGameObjectSpawned"  },
        { EveTypeGameObjectDeleted   ,  "EveTypeGameObjectDeleted"  },
        { EveTypeAssetLoad           ,  "EveTypeAssetLoad"          },
        { EveTypeAssetFree           ,  "EveTypeAssetFree"          },
